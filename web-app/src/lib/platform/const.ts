...
export const PlatformFeatures: Record<PlatformFeature, boolean> = {
  ...
  // Automatic model selection from jan provider - enabled for web and mobile
  [PlatformFeature.WEB_AUTO_MODEL_SELECTION]: !isPlatformTauri() || isPlatformIOS() || isPlatformAndroid(),
